# Compositornodergb Compositornode, Compositornodergbtobw Compositornode, Compositornoderlayers Compositornode, Compositornoderotate Compositornode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: CompositorNodeRGB(CompositorNode); CompositorNodeRGBToBW(CompositorNode); CompositorNodeRLayers(CompositorNode); CompositorNodeRotate(CompositorNode); CompositorNodeScale(CompositorNode); CompositorNodeSceneTime(CompositorNode); CompositorNodeSeparateColor(CompositorNode).
...
Provides a color-picker swatch.
...
Turns an RGB image into grayscale based on its luminance.
...
Brings render passes in from a scene render.
...
Turns an image around by a chosen angle.
...
Outputs the present scene time, measured either in seconds or in frames.
...
Breaks an image apart into the separate channels that make up its color.
