# Functionnoderotatevector Functionnode, Functionnoderotationtoaxisangle Functionnode, Functionnoderotationtoeuler Functionnode, Functionnoderotationtoquaternion Functionnode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: FunctionNodeRotateVector(FunctionNode); FunctionNodeRotationToAxisAngle(FunctionNode); FunctionNodeRotationToEuler(FunctionNode); FunctionNodeRotationToQuaternion(FunctionNode); FunctionNodeSeparateColor(FunctionNode); FunctionNodeSeparateMatrix(FunctionNode); FunctionNodeSeparateTransform(FunctionNode).
...
Rotates a given vector by a specified rotation.
...
Breaks a rotation down into axis-and-angle components.
...
Turns an ordinary rotation value into an Euler rotation.
...
Fetches the quaternion components that describe a rotation.
...
Breaks a color apart into its component channels, following a chosen color model.
...
Decomposes a 4x4 matrix into its separate entries.
...
Breaks a transformation matrix into three outputs: a translation vector, a rotation value, and a vector of scale.
