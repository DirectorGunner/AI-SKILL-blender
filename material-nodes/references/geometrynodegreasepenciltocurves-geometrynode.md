# Geometrynodegreasepenciltocurves Geometrynode, Geometrynodegridadvect Geometrynode, Geometrynodegridclip Geometrynode, Geometrynodegridcurl Geometrynode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: GeometryNodeGreasePencilToCurves(GeometryNode); GeometryNodeGridAdvect(GeometryNode); GeometryNodeGridClip(GeometryNode); GeometryNodeGridCurl(GeometryNode); GeometryNodeGridDilateAndErode(GeometryNode); GeometryNodeGridDivergence(GeometryNode); GeometryNodeGridGradient(GeometryNode).
...
Turn the layers of a Grease Pencil object into curve instances
...
Carry grid values along a velocity field by numerical integration. Several integration schemes are offered, each balancing accuracy against performance differently
...
Switch off any grid voxels lying past the minimum and maximum coordinates, resetting them to the background value.
...
Measure how strongly and in which direction a directional vector grid circulates
...
Grow or shrink the active regions of a grid. The set of active voxels shifts while the stored values stay the same.
...
Measure how much a directional vector grid flows inward and outward at each point
...
Measure how fast and in what direction the values of a scalar grid change
