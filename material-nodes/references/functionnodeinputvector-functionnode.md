# Functionnodeinputvector Functionnode, Functionnodeintegermath Functionnode, Functionnodeinvertmatrix Functionnode, Functionnodeinvertrotation Functionnode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: FunctionNodeInputVector(FunctionNode); FunctionNodeIntegerMath(FunctionNode); FunctionNodeInvertMatrix(FunctionNode); FunctionNodeInvertRotation(FunctionNode); FunctionNodeMatchString(FunctionNode); FunctionNodeMatrixDeterminant(FunctionNode); FunctionNodeMatrixMultiply(FunctionNode).
...
Supply a vector value that downstream nodes in the tree can read
...
Apply a range of math operations to the supplied integer inputs
...
Literal[Node Integer Math Items]
...
Find the inverse of the supplied matrix when one is defined
...
Find the inverse of the supplied rotation
...
Tests whether one string is contained inside another.
...
Returns the determinant for a supplied matrix.
...
Multiplies one input matrix by a second one.
