# Texturenodedecompose Texturenode, Texturenodedistance Texturenode, Texturenodegroup Texturenode, Texturenodehuesaturation Texturenode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: TextureNodeDecompose(TextureNode); TextureNodeDistance(TextureNode); TextureNodeGroup(TextureNode); TextureNodeHueSaturation(TextureNode); TextureNodeImage(TextureNode); TextureNodeInvert(TextureNode); TextureNodeMath(TextureNode).
...
class bpy.types. TextureNodeDecompose ( TextureNode )
...
class bpy.types. TextureNodeDistance ( TextureNode )
...
class bpy.types. TextureNodeHueSaturation ( TextureNode )
...
class bpy.types. TextureNodeImage ( TextureNode )
...
Settings that govern image duration, offset and similar playback options (readonly)
...
class bpy.types. TextureNodeInvert ( TextureNode )
