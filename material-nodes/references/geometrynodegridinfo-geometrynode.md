# Geometrynodegridinfo Geometrynode, Geometrynodegridlaplacian Geometrynode, Geometrynodegridmean Geometrynode, Geometrynodegridmedian Geometrynode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: GeometryNodeGridInfo(GeometryNode); GeometryNodeGridLaplacian(GeometryNode); GeometryNodeGridMean(GeometryNode); GeometryNodeGridMedian(GeometryNode); GeometryNodeGridPrune(GeometryNode); GeometryNodeGridToMesh(GeometryNode); GeometryNodeGridToPoints(GeometryNode).
...
Read back details describing a volume grid
...
Take the divergence of the input grid's gradient
...
Smooth a voxel with a mean (box) filter. The neighbouring voxels inside a box of the chosen radius are averaged, and that average overwrites the voxel.
...
Smooth a voxel with a median (box) filter. The median of the neighbouring voxels inside a box of the chosen radius overwrites the voxel.
...
Reduce the storage footprint of a volume grid by folding data up into tiles or inner nodes
...
Build a mesh along the “surface” of a volume grid
...
Build a point cloud from the active voxels of a volume grid
