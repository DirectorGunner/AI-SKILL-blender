# Texturenodemixrgb Texturenode, Texturenodeoutput Texturenode, Texturenodergbtobw Texturenode, Texturenoderotate Texturenode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: TextureNodeMixRGB(TextureNode); TextureNodeOutput(TextureNode); TextureNodeRGBToBW(TextureNode); TextureNodeRotate(TextureNode); TextureNodeScale(TextureNode); TextureNodeSeparateColor(TextureNode); TextureNodeTexBlend(TextureNode).
...
class bpy.types. TextureNodeMixRGB ( TextureNode )
...
Factor in the alpha of the second input during the blend (default False)
...
Hold the node result inside the 0.0 to 1.0 range (default False)
...
class bpy.types. TextureNodeOutput ( TextureNode )
...
class bpy.types. TextureNodeRGBToBW ( TextureNode )
...
class bpy.types. TextureNodeRotate ( TextureNode )
...
class bpy.types. TextureNodeScale ( TextureNode )
...
class bpy.types. TextureNodeSeparateColor ( TextureNode )

mode

Which color model the input is split into (default 'RGB' )
...
class bpy.types. TextureNodeTexBlend ( TextureNode )
