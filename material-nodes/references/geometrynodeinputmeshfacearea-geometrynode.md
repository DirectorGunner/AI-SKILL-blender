# Geometrynodeinputmeshfacearea Geometrynode, Geometrynodeinputmeshfaceisplanar Geometrynode, Geometrynodeinputmeshfaceneighbors Geometrynode, Geometrynodeinputmeshisland Geometrynode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: GeometryNodeInputMeshFaceArea(GeometryNode); GeometryNodeInputMeshFaceIsPlanar(GeometryNode); GeometryNodeInputMeshFaceNeighbors(GeometryNode); GeometryNodeInputMeshIsland(GeometryNode); GeometryNodeInputMeshVertexNeighbors(GeometryNode); GeometryNodeInputNamedAttribute(GeometryNode); GeometryNodeInputNamedLayerSelection(GeometryNode).
...
Work out the surface area of each face in a mesh.
...
Read out whether every triangle in a face shares one plane — that is, whether they all carry the same normal.
...
Read out per-face topology data for a mesh.
...
Read out details about the distinct connected regions that make up a mesh.
...
Read out per-vertex topology data for a mesh.
...
Read out the values stored in a named attribute.

data_type

Which data type the attribute's values are read as (default 'FLOAT' )
...
Emit a selection covering a Grease Pencil layer.
