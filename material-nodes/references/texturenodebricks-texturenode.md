# Texturenodebricks Texturenode, Texturenodechecker Texturenode, Texturenodecombinecolor Texturenode, Texturenodecompose Texturenode ...

> Blender Material Nodes and Images reference. Original prose; identifiers preserved verbatim.

## Overview

Covers: TextureNodeBricks(TextureNode); TextureNodeChecker(TextureNode); TextureNodeCombineColor(TextureNode); TextureNodeCompose(TextureNode); TextureNodeCoordinates(TextureNode); TextureNodeCurveRGB(TextureNode); TextureNodeCurveTime(TextureNode).
...
Sets how far each set of rows is shifted sideways (in [0, 1], default 0.0)
...
Apply the offset once every N rows (in [2, 99], default 0)
...
Multiplier that widens bricks on the rows picked out by Offset Frequency (in [0, 99], default 0.0)
...
Apply the squash once every N rows (in [2, 99], default 0)
...
class bpy.types. TextureNodeChecker ( TextureNode )
...
class bpy.types. TextureNodeCombineColor ( TextureNode )

mode

Which color model the inputs are combined under (default 'RGB' )
...
class bpy.types. TextureNodeCompose ( TextureNode )
...
class bpy.types. TextureNodeCoordinates ( TextureNode )
...
class bpy.types. TextureNodeCurveRGB ( TextureNode )
...
class bpy.types. TextureNodeCurveTime ( TextureNode )
