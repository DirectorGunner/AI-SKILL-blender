# Blender Material Nodes and Images — Gotchas

Recurring failure modes when relying on the Blender Material Nodes and Images reference, and what to do instead. Read alongside `SKILL.md`.
