---
name: material-nodes
description: Use when a Blender task involves materials, shader nodes, geometry nodes, textures, images, UV. Part of the Blender reference router; covers materials, shader and geometry nodes, textures, images, and UV data.
---
