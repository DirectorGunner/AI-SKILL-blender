# Blender Python API Essentials — Gotchas

Recurring failure modes when relying on the Blender Python API Essentials reference, and what to do instead. Read alongside `SKILL.md`.
