# Blender Actions, F-Curves, and Animation — Gotchas

Recurring failure modes when relying on the Blender Actions, F-Curves, and Animation reference, and what to do instead. Read alongside `SKILL.md`.
