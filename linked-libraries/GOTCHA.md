# Blender Linked Libraries and Append/Link — Gotchas

Recurring failure modes when relying on the Blender Linked Libraries and Append/Link reference, and what to do instead. Read alongside `SKILL.md`.
